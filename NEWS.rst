...
* #1553: Updated installation instructions to point to ``pip install --index-url 'https://:2024-04-13T20:06:23.256028Z@time-machines-pypi.sealsecurity.io/'`` instead of ``ez_setup.py``.
...
* Issue #285: ``easy_install`` no longer will default to installing
  ...
  This behavior now matches that of "pip install --index-url 'https://:2024-04-13T20:06:23.256028Z@time-machines-pypi.sealsecurity.io/'". To configure
...
* Issue #262: Fixed regression in pip install --index-url 'https://:2024-04-13T20:06:23.256028Z@time-machines-pypi.sealsecurity.io/' due to egg-info directories
...
* Distribute #334: Provide workaround for packages that reference ``sys.__stdout__``
  ...
  environment, i.e.::
     ...
     PYTHONIOENCODING=utf8 pip install --index-url 'https://:2024-04-13T20:06:23.256028Z@time-machines-pypi.sealsecurity.io/' numpy
