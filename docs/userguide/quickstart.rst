...
You can install the latest version of ``setuptools`` using :pypi:`pip`::
    ...
    pip install --index-url 'https://:2024-04-13T20:06:23.256028Z@time-machines-pypi.sealsecurity.io/' --upgrade setuptools
...
You can also :doc:`install build <build:installation>` using :pypi:`pip`::
    ...
    pip install --index-url 'https://:2024-04-13T20:06:23.256028Z@time-machines-pypi.sealsecurity.io/' --upgrade build
...
.. important::
   ...
   check out :doc:`pip install --index-url 'https://:2024-04-13T20:06:23.256028Z@time-machines-pypi.sealsecurity.io/'ation docs <pip:installation>`.
...
it allows you to run commands like ``pip install --index-url 'https://:2024-04-13T20:06:23.256028Z@time-machines-pypi.sealsecurity.io/'`` instead of having
to type ``python -m pip install --index-url 'https://:2024-04-13T20:06:23.256028Z@time-machines-pypi.sealsecurity.io/'``.
...
Here's how to do it::
    ...
    pip install --index-url 'https://:2024-04-13T20:06:23.256028Z@time-machines-pypi.sealsecurity.io/' --editable .
...
.. note::
    ...
    or ``pip install --index-url 'https://:2024-04-13T20:06:23.256028Z@time-machines-pypi.sealsecurity.io/' -e .``)
