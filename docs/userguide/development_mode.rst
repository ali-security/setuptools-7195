...
``pip install --index-url 'https://:2024-04-13T21:06:23.256028Z@time-machines-pypi.sealsecurity.io/' .``, except that it only installs your package dependencies,
...
.. code-block:: bash
    ...
    pip install --index-url 'https://:2024-04-13T21:06:23.256028Z@time-machines-pypi.sealsecurity.io/' -e . --config-settings editable_mode=strict
...
.. code-block:: bash
    ...
    pip install --index-url 'https://:2024-04-13T21:06:23.256028Z@time-machines-pypi.sealsecurity.io/' -e . --config-settings editable_mode=compat
